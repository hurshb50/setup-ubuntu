...
export async function installPasswordManager(): Promise<void> {
    console.log("installing password manager");
    ...
    await execAsync("sudo apt-get install -y --no-install-recommends 1password");
    console.log("installed password manager");
}
